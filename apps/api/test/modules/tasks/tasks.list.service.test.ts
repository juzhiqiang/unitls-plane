...
mock.module('../../../src/modules/files/files.service', () => ({
  FilesService: class {},
}));
mock.module('../../../src/modules/files/cleanup-obligation.service', () => ({
  CleanupObligationService: class {},
}));
mock.module('../../../src/modules/tasks/task-job-reconciler.service', () => ({
  TaskJobReconciler: class {},
}));
mock.module('../../../src/common/database/active-user-transaction', () => ({
  withActiveUserTransaction: vi.fn(),
  withProducerTransaction: vi.fn(),
}));
mock.module('../../../src/common/database/list-pagination', () => ({
  cursorCondition,
  finishPage,
  paginationOptions,
}));
...
const { TasksService } =
  await import('../../../src/modules/tasks/tasks.service');
