...
import { AccountSummaryCache } from '../../../src/common/cache/account-summary-cache.service';
import { ensureUploadTempDir } from '../../../src/modules/files/upload-temp-file';
...
const { FilesService } =
  await import('../../../src/modules/files/files.service');
