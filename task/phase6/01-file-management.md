...
> 4. 视图切换（网格/列表）：1px 边框 toggle，活跃项无填充、底部 2px accent 线
> 5. 文件卡片（网格视图）：1px 边框、左对齐元信息、mono 字体显示大小
> 6. 批量选择：复选框使用 1px 方形（非圆形），勾选用 accent 色
> 7. 回收站顶部提示用 1px 边框 warning 条，无背景色填充
