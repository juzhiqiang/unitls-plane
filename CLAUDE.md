...
- `/image`、`/image/compress`、`/image/convert`、`/image/animation`、`/image/stitch`、`/image/watermark`、`/image/id-photo`、`/image/cutout`、`/image/crop`
...
- 图片裁剪（/image/crop）纯浏览器 canvas 处理，支持定比例裁剪与输出尺寸调整。
